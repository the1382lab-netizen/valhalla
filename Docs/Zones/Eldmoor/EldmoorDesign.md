...
- **Screen (props, tile):** boulder (large, VB_BoulderLarge_A, yaw 15) (4,29); boulder (large, VB_BoulderLarge_A, yaw -15) (8,29); plug rock (VB_BoulderLarge_B, yaw 90, scale 1.25; the builder's Cleft_ScreenPlug, closing the 40-60 cm eye-height seam between the two boulders; the script places it 80 cm south of their mean, so its prop name must not contain the word boulder) (6,30); dead tree (2,34); dead tree (12,33); fallen log (5,33); fallen log (10,34); bush (4,31); bush (8,32); fern clumps (6,32); stump (11,29); rock (small) x6 scree (8,36).
