...
namespace
{
	...
	void ParseClass(FName Id, const TSharedPtr<FJsonObject>& Obj, FValhallaClassTemplate& Out)
	{
		...
		OptString(Obj, TEXT("walkSpriteSheet"), Out.WalkSpriteSheet);
		OptString(Obj, TEXT("meleeSpriteSheet"), Out.MeleeSpriteSheet);
		OptString(Obj, TEXT("rangedSpriteSheet"), Out.RangedSpriteSheet);
		OptString(Obj, TEXT("castSpriteSheet"), Out.CastSpriteSheet);
	...
	void ParseItem(FName Id, const TSharedPtr<FJsonObject>& Obj, FValhallaItemTemplate& Out)
	{
		...
		OptString(Obj, TEXT("equipSpriteSheet"), Out.EquipSpriteSheet);
		OptString(Obj, TEXT("meleeSpriteSheet"), Out.MeleeSpriteSheet);
		OptString(Obj, TEXT("rangedSpriteSheet"), Out.RangedSpriteSheet);
		OptString(Obj, TEXT("castSpriteSheet"), Out.CastSpriteSheet);
		...
		if (const TSharedPtr<FJsonObject> SpriteConfig = OptObject(Obj, TEXT("equipSpriteConfig")))
		{
			OptInt(SpriteConfig, TEXT("frameWidth"),   Out.EquipSpriteConfig.FrameWidth);
			OptInt(SpriteConfig, TEXT("frameHeight"),  Out.EquipSpriteConfig.FrameHeight);
			OptInt(SpriteConfig, TEXT("framesPerRow"), Out.EquipSpriteConfig.FramesPerRow);
			OptInt(SpriteConfig, TEXT("rows"),         Out.EquipSpriteConfig.Rows);
		}
	}
...
bool UValhallaDataSubsystem::LoadAll()
{
	...
	LoadedDataRoot = Settings ? Settings->GetResolvedDataRoot() : UValhallaDataSettings::ResolveDataRoot(FString());
