...
struct VALHALLACORE_API FValhallaClassTemplate
{
	...
	/** JSON `walkSpriteSheet` — 1.0 sprite asset name, kept for reference. */
	UPROPERTY(BlueprintReadOnly, Category = "Valhalla|Classes")
	FString WalkSpriteSheet;

	/** JSON `meleeSpriteSheet`. */
	UPROPERTY(BlueprintReadOnly, Category = "Valhalla|Classes")
	FString MeleeSpriteSheet;

	/** JSON `rangedSpriteSheet`. */
	UPROPERTY(BlueprintReadOnly, Category = "Valhalla|Classes")
	FString RangedSpriteSheet;

	/** JSON `castSpriteSheet`. */
	UPROPERTY(BlueprintReadOnly, Category = "Valhalla|Classes")
	FString CastSpriteSheet;
...
/** items.ts:148 — `EquipSpriteConfig`. Layout of an equipment sprite sheet. */
USTRUCT(BlueprintType)
struct VALHALLACORE_API FValhallaEquipSpriteConfig
{
	GENERATED_BODY()
	...
	/** JSON `framesPerRow`. */
	UPROPERTY(BlueprintReadOnly, Category = "Valhalla|Items")
	int32 FramesPerRow = 9;

	/** JSON `rows` — up, left, down, right. */
	UPROPERTY(BlueprintReadOnly, Category = "Valhalla|Items")
	int32 Rows = 4;
};
...
struct VALHALLACORE_API FValhallaItemTemplate
{
	...
	/** JSON `equipSpriteSheet`. */
	UPROPERTY(BlueprintReadOnly, Category = "Valhalla|Items")
	FString EquipSpriteSheet;
	...
	/** JSON `equipSpriteConfig` — defaults to the 4x9 64x64 body layout. */
	UPROPERTY(BlueprintReadOnly, Category = "Valhalla|Items")
	FValhallaEquipSpriteConfig EquipSpriteConfig;

	/** JSON `inventoryIcon`. */
	UPROPERTY(BlueprintReadOnly, Category = "Valhalla|Items")
	FString InventoryIcon;

	/** JSON `spriteId` — paperdoll layer id, preferred over the sheets above. */
	UPROPERTY(BlueprintReadOnly, Category = "Valhalla|Items")
	FString SpriteId;
