...
var _TypeContext = class _TypeContext {
  ...
  discoverTypes(klass, parentType, parentIndex, parentHasViewTag) {
    ...
    (_a7 = _TypeContext.inheritedTypes.get(klass)) == null ? void 0 : _a7.forEach((child) => {
    ...
    const metadata = klass[_b6 = Symbol.metadata] ?? (klass[_b6] = {});
...
Schema instances may only have up to 64 fields.`);
  ...
  hasViewTagAtIndex(metadata, index) {
    var _a7;
    return (_a7 = metadata == null ? void 0 : metadata[$viewFieldIndexes]) == null ? void 0 : _a7.includes(index);
  }
};
...
function deleteOperationAtIndex(changeSet, index) {
  ...
  if (operationsIndex === void 0) {
    ...
    index = (_a7 = Object.entries(changeSet.indexes).find(([_, value]) => value === operationsIndex)) == null ? void 0 : _a7[0];
  }
...
var ChangeTree = class {
  constructor(ref) {
    ...
    if ((_a7 = this.metadata) == null ? void 0 : _a7[$viewFieldIndexes]) {
    ...
    if (this.ref[$childType]) {
      if (typeof this.ref[$childType] !== "string") {
        for (const [key, value] of this.ref.entries()) {
          ...
          callback(value[$changes], ((_a7 = this.indexes) == null ? void 0 : _a7[key]) ?? key);
        }
      }
    } else {
      for (const index of ((_b6 = this.metadata) == null ? void 0 : _b6[$refTypeFieldIndexes]) ?? []) {
  ...
  operation(op) {
    ...
    if (this.filteredChanges !== void 0) {
      ...
      (_a7 = this.root) == null ? void 0 : _a7.enqueueChangeTree(this, "filteredChanges");
    } else {
      this.changes.operations.push(-op);
      (_b6 = this.root) == null ? void 0 : _b6.enqueueChangeTree(this, "changes");
    }
  }
  change(index, operation = OPERATION.ADD) {
    var _a7, _b6, _c6;
    const isFiltered = this.isFiltered || ((_b6 = (_a7 = this.metadata) == null ? void 0 : _a7[index]) == null ? void 0 : _b6.tag) !== void 0;
    ...
    if (isFiltered) {
      ...
      (_c6 = this.root) == null ? void 0 : _c6.enqueueChangeTree(this, "changes");
    }
  }
  ...
  delete(index, operation, allChangesIndex = index) {
    ...
    if (previousValue && previousValue[$changes]) {
      (_a7 = this.root) == null ? void 0 : _a7.remove(previousValue[$changes]);
    }
    if (this.filteredChanges !== void 0) {
      deleteOperationAtIndex(this.allFilteredChanges, allChangesIndex);
      (_b6 = this.root) == null ? void 0 : _b6.enqueueChangeTree(this, "filteredChanges");
    } else {
      (_c6 = this.root) == null ? void 0 : _c6.enqueueChangeTree(this, "changes");
    }
  ...
  endEncode(changeSetName) {
    ...
    (_b6 = (_a7 = this.ref)[$onEncodeEnd]) == null ? void 0 : _b6.call(_a7);
    this.isNew = false;
  }
  ...
  checkIsFiltered(parent, parentIndex, isNewChangeTree) {
    ...
    if (this.root.types.hasFilters) {
      ...
      if (this.filteredChanges !== void 0) {
        (_a7 = this.root) == null ? void 0 : _a7.enqueueChangeTree(this, "filteredChanges");
        if (isNewChangeTree) {
          (_b6 = this.root) == null ? void 0 : _b6.enqueueChangeTree(this, "allFilteredChanges");
        }
      }
    }
    if (!this.isFiltered) {
      (_c6 = this.root) == null ? void 0 : _c6.enqueueChangeTree(this, "changes");
      if (isNewChangeTree) {
        (_d6 = this.root) == null ? void 0 : _d6.enqueueChangeTree(this, "allChanges");
      }
    }
  }
  ...
  get parent() {
    var _a7;
    return (_a7 = this.parentChain) == null ? void 0 : _a7.ref;
  }
  /**
  ...
  get parentIndex() {
    var _a7;
    return (_a7 = this.parentChain) == null ? void 0 : _a7.index;
  }
  /**
...
function encodeValue(encoder, bytes, type, value, operation, it) {
  var _a7;
  if (typeof type === "string") {
    (_a7 = encode[type]) == null ? void 0 : _a7.call(encode, bytes, value, it);
...
function decodeValue(decoder2, operation, ref, index, type, bytes, it, allChanges) {
  ...
  if ((operation & OPERATION.DELETE) === OPERATION.DELETE) {
    const previousRefId = previousValue == null ? void 0 : previousValue[$refId];
...
var _ArraySchema = class _ArraySchema {
        ...
        if (typeof key !== "symbol" && !isNaN(key)) {
          if (setValue === void 0 || setValue === null) {
            ...
            if (setValue[$changes]) {
              ...
              if (previousValue !== void 0) {
                (_a7 = previousValue[$changes].root) == null ? void 0 : _a7.remove(previousValue[$changes]);
              }
            } else {
              obj.$changeAt(Number(key), setValue);
            }
  ...
  static [(_f = $changes, _e = $refId, _d = $childType, _c = $encoder, _b = $decoder, $filter)](ref, index, view2) {
    var _a7;
    return !view2 || typeof ref[$childType] === "string" || view2.isChangeTreeVisible((_a7 = ref["tmpItems"][index]) == null ? void 0 : _a7[$changes]);
  }
  static is(type) {
    return (
      // type format: ["string"]
  ...
  push(...values) {
    ...
    for (let i = 0, l = values.length; i < l; i++, length++) {
      ...
      (_a7 = value[$changes]) == null ? void 0 : _a7.setParent(this, changeTree.root, length);
    }
    return length;
  }
  /**
  ...
  $changeAt(index, value) {
    ...
    (_a7 = value[$changes]) == null ? void 0 : _a7.setParent(this, changeTree.root, index);
  }
  // encoding only
  ...
  clear() {
    ...
    changeTree.forEachChild((childChangeTree, _) => {
      var _a7;
      (_a7 = changeTree.root) == null ? void 0 : _a7.remove(childChangeTree);
    });
  ...
  splice(start, deleteCount, ...insertItems) {
    ...
    if (insertCount > 0) {
      ...
      for (let i = 0; i < insertCount; i++) {
        ...
        (_a7 = insertItems[i][$changes]) == null ? void 0 : _a7.setParent(this, changeTree.root, addIndex);
      }
    }
    ...
    if (changeTree.filteredChanges !== void 0) {
      (_b6 = changeTree.root) == null ? void 0 : _b6.enqueueChangeTree(changeTree, "filteredChanges");
    } else {
      (_c6 = changeTree.root) == null ? void 0 : _c6.enqueueChangeTree(changeTree, "changes");
    }
...
var _SetSchema = class _SetSchema {
  ...
  add(value) {
    ...
    const operation = ((_a7 = this[$changes].indexes[index]) == null ? void 0 : _a7.op) ?? OPERATION.ADD;
    this[$changes].indexes[index] = index;
    this.$indexes.set(index, index);
    this.$items.set(index, value);
    ...
    set: function(value) {
      ...
      if (value !== void 0 && value !== null) {
        ...
        if (previousValue !== void 0 && previousValue[$changes]) {
          (_a7 = changeTree.root) == null ? void 0 : _a7.remove(previousValue[$changes]);
        ...
        (_b6 = value[$changes]) == null ? void 0 : _b6.setParent(this, changeTree.root, fieldIndex);
...
var _Schema = class _Schema {
  ...
  static initialize(instance) {
    ...
    Object.defineProperties(instance, ((_a7 = instance.constructor[Symbol.metadata]) == null ? void 0 : _a7[$descriptors]) || {});
  }
  static is(type) {
   ...
   */
  static isSchema(obj) {
    return typeof (obj == null ? void 0 : obj.assign) === "function";
  }
  /**
  ...
  static [$filter](ref, index, view2) {
    var _a7, _b6;
    const metadata = ref.constructor[Symbol.metadata];
    const tag = (_a7 = metadata[index]) == null ? void 0 : _a7.tag;
    if (view2 === void 0) {
      return tag === void 0;
    } else if (tag === void 0) {
      return true;
      ...
      const tags = (_b6 = view2.tags) == null ? void 0 : _b6.get(ref[$changes]);
  ...
  clone() {
    ...
    for (const fieldIndex in metadata) {
      ...
      if (typeof this[field] === "object" && typeof ((_a7 = this[field]) == null ? void 0 : _a7.clone) === "function") {
  ...
  static debugRefIds(ref, showContents = false, level = 0, decoder2, keyPrefix = "") {
    ...
    const refCount = ((_a7 = root == null ? void 0 : root.refCount) == null ? void 0 : _a7[refId]) > 1 ? ` [×${root.refCount[refId]}]` : "";
...
`;
  ...
  static debugChangesDeep(ref, changeSetName = "changes") {
    ...
    for (const [refId, changes] of Object.entries(root[changeSetName])) {
      ...
      let parentChangeTree = (_a7 = changeTree.parent) == null ? void 0 : _a7[$changes];
      if (changeTree === rootChangeTree) {
        ...
        while (parentChangeTree !== void 0) {
          ...
          parentChangeTree = (_b6 = parentChangeTree.parent) == null ? void 0 : _b6[$changes];
        }
      }
...
var Root = class {
  ...
  moveNextToParentInChangeTreeList(changeSetName, changeTree) {
    ...
    if (!parent || !parent[$changes])
      return;
    const parentNode = (_a7 = parent[$changes][changeSetName]) == null ? void 0 : _a7.queueRootNode;
...
var ReferenceTracker = class {
  ...
  removeCallback(refId, field, callback) {
    var _a7, _b6, _c6;
    const index = (_c6 = (_b6 = (_a7 = this.callbacks) == null ? void 0 : _a7[refId]) == null ? void 0 : _b6[field]) == null ? void 0 : _c6.indexOf(callback);
  ...
  decode(bytes, it = { offset: 0 }, ref = this.state) {
    ...
    while (it.offset < totalBytes) {
      if (bytes[it.offset] == SWITCH_TO_STRUCTURE) {
        it.offset++;
        (_a7 = ref[$onDecodeEnd]) == null ? void 0 : _a7.call(ref);
    ...
    (_b6 = ref[$onDecodeEnd]) == null ? void 0 : _b6.call(ref);
    (_c6 = this.triggerChanges) == null ? void 0 : _c6.call(this, allChanges);
...
function getDecoderStateCallbacks(decoder2) {
  ...
  decoder2.triggerChanges = function(allChanges) {
    ...
    for (let i = 0, l = allChanges.length; i < l; i++) {
      ...
      if ((change.op & OPERATION.DELETE) === OPERATION.DELETE && Schema.isSchema(change.previousValue)) {
        const deleteCallbacks = (_a7 = callbacks[change.previousValue[$refId]]) == null ? void 0 : _a7[OPERATION.DELETE];
      ...
      if (Schema.isSchema(ref)) {
        if (!uniqueRefIds.has(refId)) {
          const replaceCallbacks = $callbacks == null ? void 0 : $callbacks[OPERATION.REPLACE];
  ...
  function getProxy(metadataOrType, context) {
    var _a7;
    let metadata = ((_a7 = context.instance) == null ? void 0 : _a7.constructor[Symbol.metadata]) || metadataOrType;
    ...
    if (metadata && !isCollection) {
      ...
      return new Proxy({
        ...
        get(target2, prop) {
          ...
          if (metadataField) {
            const instance = (_a8 = context.instance) == null ? void 0 : _a8[prop];
            const onInstanceAvailable = ((callback) => {
              const unbind = $(context.instance).listen(prop, (value, _) => {
                callback(value, false);
                unbind == null ? void 0 : unbind();
              }, false);
              if ((instance == null ? void 0 : instance[$refId]) !== void 0) {
                callback(instance, true);
              }
            });
            return getProxy(metadataField.type, {
              // make sure refId is available, otherwise need to wait for the instance to be available.
              instance: (instance == null ? void 0 : instance[$refId]) !== void 0 && instance,
...
var StateCallbackStrategy = class {
  constructor(decoder2) {
    ...
    __publicField(this, "uniqueRefIds", /* @__PURE__ */ new Set());
    __publicField(this, "isTriggering", false);
  ...
  triggerChanges(allChanges) {
    ...
    for (let i = 0, l = allChanges.length; i < l; i++) {
      ...
      if ((change.op & OPERATION.DELETE) === OPERATION.DELETE && Schema.isSchema(change.previousValue)) {
        ...
        const deleteCallbacks = (_a7 = this.callbacks[childRefId]) == null ? void 0 : _a7[OPERATION.DELETE];
        if (deleteCallbacks) {
...
var WebSocketTransport = class {
  ...
  connect(url, headers) {
    ...
    this.ws.onopen = (event) => {
      var _a7, _b6;
      return (_b6 = (_a7 = this.events).onopen) == null ? void 0 : _b6.call(_a7, event);
    };
    this.ws.onmessage = (event) => {
      var _a7, _b6;
      return (_b6 = (_a7 = this.events).onmessage) == null ? void 0 : _b6.call(_a7, event);
    };
    this.ws.onclose = (event) => {
      var _a7, _b6;
      return (_b6 = (_a7 = this.events).onclose) == null ? void 0 : _b6.call(_a7, event);
    };
    this.ws.onerror = (event) => {
      var _a7, _b6;
      return (_b6 = (_a7 = this.events).onerror) == null ? void 0 : _b6.call(_a7, event);
    };
  }
  close(code, reason) {
...
var createNanoEvents = () => ({
  ...
  on(event, cb) {
    var _a7;
    ((_a7 = this.events[event]) == null ? void 0 : _a7.push(cb)) || (this.events[event] = [cb]);
    return () => {
      var _a8;
      this.events[event] = (_a8 = this.events[event]) == null ? void 0 : _a8.filter((i) => cb !== i);
    };
  }
});
...
var Room = class {
  ...
  connect(endpoint, options, headers) {
    ...
    this.connection.events.onclose = (e) => {
      ...
      if (this.joinedAtTime === 0) {
        (_a8 = console.warn) == null ? void 0 : _a8.call(console, `Room connection was closed unexpectedly (${e.code}): ${e.reason}`);
    ...
    const skipHandshake = ((_a7 = this.serializer) == null ? void 0 : _a7.getState()) !== void 0;
  ...
  ping(callback) {
    var _a7;
    if (!((_a7 = this.connection) == null ? void 0 : _a7.isOpen)) {
      return;
    }
  ...
  dispatchMessage(type, message) {
    ...
    if (this.onMessageHandlers.events[messageType]) {
      ...
      (_a7 = console.warn) == null ? void 0 : _a7.call(console, `@colyseus/sdk: onMessage() not registered for type '${type}'.`);
    }
  }
  destroy() {
    if (this.serializer) {
...
var HTTP = class {
  ...
  async executeRequest(method, path, requestOptions) {
    var _a7;
    let body = this.options.body ? { ...this.options.body, ...(requestOptions == null ? void 0 : requestOptions.body) || {} } : requestOptions == null ? void 0 : requestOptions.body;
    const query = this.options.query ? { ...this.options.query, ...(requestOptions == null ? void 0 : requestOptions.query) || {} } : requestOptions == null ? void 0 : requestOptions.query;
    const params = this.options.params ? { ...this.options.params, ...(requestOptions == null ? void 0 : requestOptions.params) || {} } : requestOptions == null ? void 0 : requestOptions.params;
    const headers = new Headers(this.options.headers ? { ...this.options.headers, ...(requestOptions == null ? void 0 : requestOptions.headers) || {} } : requestOptions == null ? void 0 : requestOptions.headers);
    ...
    const mergedOptions = {
      credentials: (requestOptions == null ? void 0 : requestOptions.credentials) || "include",
      ...this.options,
      ...requestOptions,
      query,
      params,
    ...
    try {
      ...
      const networkError = new ServerError(((_a7 = err.cause) == null ? void 0 : _a7.code) || err.code, err.message);
    ...
    if (contentType == null ? void 0 : contentType.indexOf("json")) {
      data = await raw.json();
    } else if (contentType == null ? void 0 : contentType.indexOf("text")) {
      data = await raw.text();
    } else {
      data = await raw.blob();
    }
  ...
  async signInWithProvider(providerName, settings = {}) {
    return new Promise((resolve, reject) => {
      ...
      const onMessage = (event) => {
        ...
        (_a7 = __privateGet(this, __signInWindow)) == null ? void 0 : _a7.close();
...
function discordURLBuilder(url) {
  var _a7;
  const localHostname = ((_a7 = window == null ? void 0 : window.location) == null ? void 0 : _a7.hostname) || "localhost";
...
var _a6;
var DEFAULT_ENDPOINT = typeof window !== "undefined" && typeof ((_a6 = window == null ? void 0 : window.location) == null ? void 0 : _a6.hostname) !== "undefined" ? `${window.location.protocol.replace("http", "ws")}//${window.location.hostname}${window.location.port && `:${window.location.port}`}` : "ws://127.0.0.1:2567";
var _ColyseusSDK = class _ColyseusSDK {
  constructor(settings = DEFAULT_ENDPOINT, options) {
    ...
    if (options == null ? void 0 : options.protocol) {
    ...
    this.urlBuilder = options == null ? void 0 : options.urlBuilder;
    if (!this.urlBuilder && typeof window !== "undefined" && ((_b6 = (_a7 = window == null ? void 0 : window.location) == null ? void 0 : _a7.hostname) == null ? void 0 : _b6.includes("discordsays.com"))) {
...
//# sourceMappingURL=@colyseus_sdk.js.map
