...
// src/ClockTimer.ts
var ClockTimer_exports = {};
__export(ClockTimer_exports, {
  ClockTimer: () => ClockTimer
});
module.exports = __toCommonJS(ClockTimer_exports);
var import_clock = require("@colyseus/clock");
var import_Delayed = require("./Delayed.cjs");
var import_TimerClearedError = require("./TimerClearedError.cjs");
var ClockTimer = class extends import_clock.Clock {
  ...
  setInterval(handler, time, ...args) {
    const delayed = new import_Delayed.Delayed(handler, args, time, import_Delayed.Type.Interval);
  ...
  setTimeout(handler, time, ...args) {
    const delayed = new import_Delayed.Delayed(handler, args, time, import_Delayed.Type.Timeout);
    this.delayed.push(delayed);
    return delayed;
  }
  /**
  ...
  duration(ms) {
    return new Promise((resolve, reject) => {
      const delayed = new import_Delayed.Delayed(resolve, void 0, ms, import_Delayed.Type.Async);
      delayed.clear = () => {
        delayed.active = false;
        reject(new import_TimerClearedError.TimerClearedError());
      };
      this.delayed.push(delayed);
    });
  }
