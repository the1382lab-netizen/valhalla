...
import { ClassId } from '@valhalla/shared';
...
export class CharacterSelectScene extends Phaser.Scene {
  ...
  private createCharacterCard(
    ...
    const classColor = ClientDataManager.instance.getClassColor(char.classId) ?? 0xcccccc;
    const hexColor = '#' + classColor.toString(16).padStart(6, '0');
    const template = ClientDataManager.instance.getClass(char.classId);
