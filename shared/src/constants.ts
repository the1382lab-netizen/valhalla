...
/**
 * Version of the game data in shared/data, reported by the backend's
 * /api/data/manifest. Still 0 while the game is pre-release; it becomes a real
 * release number once updates are versioned. Clients compare file hashes, not
 * this number, to decide what to download.
 */
