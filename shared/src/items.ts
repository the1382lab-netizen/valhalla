...
export interface ItemTemplate {
  ...
  /**
   * Inventory icon file name, e.g. `sword_iron.png`. Unreal shows the texture
   * imported from `Import/UI/Icons/` (/Game/Valhalla/UI/Icons/Items/<name>).
   */
  inventoryIcon?: string;
  /**
   * 1.0 paperdoll layer id, e.g. `chest_iron_plate`. Still the Unreal art id
   * when `meshId` is empty (FValhallaItemTemplate::GetArtId).
   */
  spriteId?: string;
